      ...
      <main className="px-6 mt-10 space-y-12 relative z-10">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between px-2">
            ...
            <span className="text-[10px] font-black text-[#E07A3D] uppercase tracking-[0.2em]">
              {stats.inQueue || displayQueue.length} Songs
            </span>
          </div>
          <div className="space-y-3">
            {displayQueue.length > 0 ? (
              ...
              <div className="bg-[#111113] p-8 rounded-[2.5rem] border border-white/5 text-center">
                <FaMusic className="mx-auto text-gray-600 mb-3" size={32} />
          ...
          {displayQueue.length > 5 && (
            ...
            >
              Full Queue ({displayQueue.length})
            </button>
          )}
        </div>
      </main>
